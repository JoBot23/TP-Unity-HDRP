...
public class SpawnCube : MonoBehaviour
{
    ...
    {
        GameObject.Instantiate(PetitCubeAsset, new Vector3(transform.position.x, transform.position.y+2f, transform.position.z) + OffsetCreation, Quaternion.identity);
    }
